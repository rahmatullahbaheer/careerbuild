...
function ResumePreview() {
  return (
    <div className="relative w-full max-w-xs mx-auto">
      ...
      >
        {/* Resume header bar */}
        <div className="bg-gradient-to-br from-blue-800 to-indigo-700 px-5 py-5">
      ...
      >
        ...
        <div>
          <div className="text-[9px] font-semibold text-zinc-900">
            ATS Score
          </div>
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <div className="text-[9px] font-semibold text-zinc-500 mb-0.5">
          Template
        </div>
...
export default function Hero() {
  ...
  return (
    <section
      className="relative min-h-screen flex items-center pt-6 overflow-hidden bg-white"
