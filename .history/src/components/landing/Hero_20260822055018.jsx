        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-indigo-950 p-5 text-white">
          <div className="flex items-center gap-3.5">
            ...
            <div className="relative flex-shrink-0">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-blue-500 to-indigo-500 p-0.5 shadow-md">
...
export default function Hero() {
  ...
  return (
    <section
      className="relative flex items-center overflow-hidden bg-white pt-24 pb-12 sm:pt-28 sm:pb-16 lg:pt-32 lg:pb-16"
