...
export default function FinalCTA() {
  ...
  return (
    ...
    >
      {/* Background */}
      <div className="absolute inset-0 landing-dot-grid opacity-40" aria-hidden="true" />
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(ellipse 70% 70% at 50% 50%, rgba(79, 70, 229, 0.06) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      {/* Decorative blobs */}
      <div
        className="glow-blob w-80 h-80 bg-indigo-300/20 -top-20 -left-20"
        aria-hidden="true"
      />
      <div
        className="glow-blob w-72 h-72 bg-violet-300/15 -bottom-10 -right-10"
        aria-hidden="true"
      />

      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Badge */}
        <AnimatedSection variants={fadeUp} className="mb-6">
        ...
        {/* Heading */}
        <AnimatedSection variants={fadeUp} delay={0.1} className="mb-5">
          <h2
            id="final-cta-heading"
            className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-zinc-900 leading-[1.1]"
          >
        ...
        {/* Subtext */}
        <AnimatedSection variants={fadeUp} delay={0.2} className="mb-10">
          <p className="text-lg text-zinc-500 max-w-xl mx-auto leading-relaxed">
            Build a professional resume today and take the next step toward your career goals.
            No experience required — just your story.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection variants={fadeUp} delay={0.4} className="mt-8">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-zinc-400">
            ...
            <span className="hidden sm:inline text-zinc-200" aria-hidden="true">·</span>
            <span className="flex items-center gap-1.5">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
            ...
            <span className="flex items-center gap-1.5">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
                <path d="M7 2L8.5 5.5H12L9 7.5L10.5 11L7 8.5L3.5 11L5 7.5L2 5.5H5.5L7 2Z" fill="#f59e0b"/>
              </svg>
              4.9/5 rating
            </span>
          </div>
