...
import AnimatedSection, { fadeUp, slideInLeft, slideInRight } from "./shared/AnimatedSection";
...
const examples = [
  {
    ...
    after: "Developed and maintained responsive web applications using React and Node.js, improving page load time by 35% and increasing user engagement metrics.",
  },
  {
    label: "Professional Summary",
    before: "I am a software developer with experience.",
    after: "Results-driven software engineer with 5+ years of experience building scalable web applications, leading cross-functional teams, and delivering solutions that drive measurable business impact.",
  },
  {
    label: "Achievement",
    before: "Helped increase sales.",
    after: "Spearheaded a data-driven sales optimization initiative that increased quarterly revenue by 28% and reduced customer acquisition costs by 15%.",
  },
];
...
export default function AIResumeSection() {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(135deg, #0f0f23 0%, #1a0a2e 40%, #0a1a2e 100%)",
      }}
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <AnimatedSection variants={slideInLeft}>
            ...
            {/* Example tabs */}
            <div className="flex flex-wrap gap-2" role="tablist" aria-label="AI example types">
              {examples.map((ex, i) => (
                <button
                  key={ex.label}
                  role="tab"
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="p-3.5 rounded-xl bg-red-500/5 border border-red-500/15">
                  <p className="text-sm text-red-300/90 leading-relaxed">{current.before}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 my-4">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-600/20 border border-indigo-500/30">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="none" aria-hidden="true">
                    <path d="M6 1.5L7.5 4.5H11L8.5 6.5L9.5 9.5L6 7.5L2.5 9.5L3.5 6.5L1 4.5H4.5L6 1.5Z" fill="#818cf8" />
                  </svg>
                  <span className="text-[10px] font-semibold text-indigo-400">AI Enhanced</span>
                </div>
                <div className="flex-1 h-px bg-white/10" />
              </div>
