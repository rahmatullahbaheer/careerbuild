    ...
    <div className="bg-white border-r border-zinc-100 rounded-l-2xl overflow-hidden flex flex-col">
      ...
      <div className="px-4 py-3 border-t border-zinc-100">
        <div className="flex justify-between items-center mb-1.5">
          <span className="text-[10px] font-medium text-zinc-500">Profile Complete</span>
      ...
      <div className="max-w-xs mx-auto">
        ...
        >
          ...
          <div className="bg-indigo-600 px-4 py-3">
            <div className="h-2.5 bg-white/80 rounded-full w-28 mb-1.5" />
          ...
          <div className="px-4 py-3 space-y-3">
            {/* Typing animation for current field */}
            <div>
              <div className="text-[8px] font-bold uppercase tracking-widest text-indigo-600 mb-1">
                Personal Information
              </div>
              <div className="space-y-1.5">
                <div className="flex items-center gap-2">
                  <div className="text-[8px] text-zinc-400 w-12 flex-shrink-0">Name</div>
                  <div className="h-1.5 bg-zinc-800 rounded-full flex-1" />
                </div>
                <div className="flex items-center gap-2">
                  <div className="text-[8px] text-zinc-400 w-12 flex-shrink-0">Role</div>
                  <div className="h-1.5 bg-zinc-300 rounded-full w-20" />
                </div>
                <div className="flex items-center gap-2">
                  <div className="text-[8px] text-zinc-400 w-12 flex-shrink-0">Email</div>
                  <div className="h-1.5 bg-zinc-300 rounded-full w-24" />
                </div>
                <div className="flex items-center gap-2">
                  <div className="text-[8px] text-zinc-400 w-12 flex-shrink-0">Phone</div>
                  <div className="h-1.5 bg-zinc-300 rounded-full w-16" />
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-zinc-100 pt-2">
              ...
              <div className="space-y-1">
                <div className="h-1.5 bg-zinc-800 rounded-full w-24" />
                <div className="h-1.5 bg-zinc-200 rounded-full w-16" />
            ...
            <div className="border-t border-zinc-100 pt-2">
              ...
              <div className="flex flex-wrap gap-1">
                {["React", "Node", "SQL"].map((s) => (
                  <span key={s} className="px-1 py-0.5 text-[7px] bg-indigo-50 text-indigo-600 rounded">
                    {s}
                  </span>
                ))}
              </div>
