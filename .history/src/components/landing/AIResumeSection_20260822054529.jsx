...
export default function AIResumeSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg, #0a0f1e 0%, #0d1b3e 45%, #0a1628 100%)",
      }}
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <AnimatedSection variants={slideInLeft}>
            <p className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-widest text-blue-400 mb-4">
              AI-Powered
            </p>
            <h2
              id="ai-heading"
