    ...
    >
      ...
      <div className="bg-zinc-900 px-5 py-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-xs font-mono text-zinc-400">ats-scanner.exe</span>
        </div>
        <div className="font-mono text-xs text-zinc-400 space-y-0.5">
          ...
          <p>
            <span className="text-emerald-400">▶</span> Analyzing structure and content...
          </p>
          <motion.p
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <AnimatedSection variants={slideInLeft} className="order-2 lg:order-1">
            <ATSChecker />
          </AnimatedSection>

          {/* Right: Copy */}
          <AnimatedSection variants={slideInRight} className="order-1 lg:order-2">
            <SectionHeader
            ...
            <ul className="mt-6 space-y-3" aria-label="ATS optimization features">
              {[
