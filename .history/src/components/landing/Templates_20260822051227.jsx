...
function TemplateMockup({ template }) {
  return (
    <div
      className="bg-white rounded-xl overflow-hidden border border-zinc-200 shadow-sm w-full aspect-[3/4] flex flex-col"
      aria-hidden="true"
    >
      {/* Template header */}
      ...
      <div className="flex-1 px-3 py-3 space-y-2.5">
        <div>
          <div
            className="h-1.5 rounded-full w-14 mb-1.5"
        ...
        <div>
          <div
            className="h-1.5 rounded-full w-10 mb-1.5"
            style={{ backgroundColor: template.accentColor + "66" }}
          />
    ...
    >
      ...
      <div className="flex items-center justify-between px-0.5">
        <div>
          ...
          <span
            className={`inline-block mt-0.5 px-2 py-0.5 text-[10px] font-medium rounded-full ${template.badge}`}
          >
            {template.category}
          </span>
        </div>
