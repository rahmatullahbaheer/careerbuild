    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div
            className="hidden md:block absolute top-10 left-[calc(16.67%+32px)] right-[calc(16.67%+32px)] h-px bg-gradient-to-r from-blue-300/60 via-indigo-300/60 to-blue-300/60"
            aria-hidden="true"
          />
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              {/* Step number label */}
              <div
                className={`text-xs font-bold tracking-widest uppercase ${step.textColor} mb-2`}
              >
                {step.number}
              </div>
